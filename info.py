...
PICS = (environ.get('PICS', 'https://i.ibb.co/cStykM1f/photo-2025-03-01-02-47-16-7477075451408547844.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2109293826').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001794150985').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kanoxa1586:Noha9980@cluster0.s6d8n.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Businessdealsonly')
